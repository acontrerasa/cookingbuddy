...
public class SelectionFragment extends Fragment {
    ...
    private class PeopleListElement extends BaseListElement {
        ...
        protected void onActivityResult(Intent data) {
            selectedUsers = ((CookingBuddyApplication) getActivity().getApplication()).getSelectedUsers();
            setUsersText();
            notifyDataChanged();
        }
    ...
    private class LocationListElement extends BaseListElement {
        ...
        @Override
        protected void onActivityResult(Intent data) {
            selectedPlace = ((CookingBuddyApplication) getActivity().getApplication()).getSelectedPlace();
            setPlaceText();
            notifyDataChanged();
        }
